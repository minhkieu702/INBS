...
namespace INBS.Domain
{
    ...
    [Migration("20241223095025_EditNailDesignTable")]
    partial class EditNailDesignTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("INBS.Domain.Entities.FavoriteDesign", b =>
                {
                    b.Property<Guid>("DesignId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("INBS.Domain.Entities.NailDesignSkinTone", b =>
                {
                    b.Property<Guid>("SkinToneId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("INBS.Domain.Entities.OccasionPreference", b =>
                {
                    b.Property<Guid>("OccasionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("INBS.Domain.Entities.Customer", b =>
                {
                    b.HasOne("INBS.Domain.Entities.SkinTone", "SkinTone")
                        .WithMany("Customer")
            ...
            modelBuilder.Entity("INBS.Domain.Entities.Notification", b =>
                {
                    b.HasOne("INBS.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("INBS.Domain.Entities.Notification", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
